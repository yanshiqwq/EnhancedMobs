...
object GenericApi {
     ...
     */
    inline fun Attributable.addModifier(name: String, operation: Operation, uuid: UUID? = null, block: AttributeBuilder.() -> Unit) =
    ...
    fun Entity.sound(sound: Sound, category: SoundCategory, volume: Float, pitch: Float) = sound(location, sound, category, volume, pitch)
